...
A self-contained (numpy/scipy/torch) example of prior laundering. The forward operator is a
...
from priorlaundermat.groundwater.map_solver import map_reconstruct
from priorlaundermat.groundwater.pcn import (LEVELS, DarcySetup, coverage, iat_sokal, load_flow,
                                             pcn_posterior, setup)
